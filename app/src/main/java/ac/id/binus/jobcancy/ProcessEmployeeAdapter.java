...
public class ProcessEmployeeAdapter extends RecyclerView.Adapter<ProcessEmployeeAdapter.CompanyViewHolder>{

    private List<MsApplicant> applicantList= new ArrayList<>();
    private OnItemClick listener;

    public ProcessEmployeeAdapter(OnItemClick listener){
